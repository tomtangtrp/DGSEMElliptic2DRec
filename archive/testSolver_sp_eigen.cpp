...
if ((A * u_h).isApprox(b) == false) {
    ...
    //std::cout << "Solver method=" <<  "Sparse Direct" << ", package=" << "Eigen intel MKL PardisoLDLT and PardisoLU" << "\n";
    std::cout << "Solver method=" <<  "Sparse Direct" << ", package=" << "Eigen Sparse SimplicialLDLT and SparseLU" << "\n";
